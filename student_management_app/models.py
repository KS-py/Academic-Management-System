...
#Function which will automatically insert data into HOD, STAFF or  STUDENT 
@receiver(post_save, sender=CustomUser)		## CREATING DJANGO SIGNALS

def create_user_profile(sender, instance, created, **kwargs):
	#if Created is true (insert data)
	if created:
